...
class CheckController extends Controller
{
    ...
    public function process(Request $request)
    {
        ...
        try {
            ...
            \Log::info('Followers data structure:', ['keys' => array_keys($followersData)]);
            \Log::info('Following data structure:', ['keys' => array_keys($followingData)]);
            ...
            \Log::info('Processing results:', [
                ...
                'followers_sample' => array_slice($followers, 0, 5),
                'following_sample' => array_slice($following, 0, 5)
            ]);
    ...
    private function extractFollowersData($data)
    {
        ...
        \Log::info('Extracting followers from:', $data);
        ...
        \Log::info('Extracted followers:', $usernames);
    ...
    private function extractFollowingData($data)
    {
        ...
        \Log::info('Extracting following from:', ['data_keys' => array_keys($data)]);
        ...
        \Log::info('Extracted following:', $usernames);
        return array_unique(array_filter($usernames));
    }
