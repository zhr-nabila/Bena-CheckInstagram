...
class LanguageManager {
  constructor() {
    ...
    this.translations = {
      en: {
        ...
        heroSubtitle: "Uncover who's not following you back with our sophisticated analytics platform.",
        ...
        analyzing: "Analyzing your Instagram network...",
        ...
        perfectBalanceDesc: "Everyone follows you back!",
        downloadReport: "Download Report",
        newAnalysis: "New Analysis",
        craftedBy: "Created by",
        uploadBothError: "Please upload both files",
        jsonOnlyError: "Please upload JSON files only",
        pdfSuccess: "PDF downloaded successfully!"
      },
      id: {
        heroTitle: "Temukan Lingkaran Instagram Anda",
        heroSubtitle: "Ungkap siapa yang tidak follow balik dengan platform analisis kami.",
        ...
        uploadBothFiles: "Unggah Kedua File untuk Lanjut",
        analyzeData: "Analisis Data Instagram", 
        analyzing: "Menganalisis jaringan Instagram...",
        ...
        notFollowingBackList: "Akun Tidak Follow Balik",
        perfectBalance: "Engagement Sempurna",
        perfectBalanceDesc: "Semua follow balik!",
        downloadReport: "Unduh Laporan",
        newAnalysis: "Analisis Baru",
        craftedBy: "Dibuat oleh",
        uploadBothError: "Harap unggah kedua file",
        jsonOnlyError: "Harap unggah file JSON saja",
  ...
  updateLanguageToggle() {
    ...
    if (toggle) {
      const flag = this.currentLang === 'en' ? '🇺🇸' : '🇮🇩';
      const text = this.currentLang === 'en' ? 'EN' : 'ID';
      toggle.innerHTML = `${flag} ${text}`;
    }
  }
...
class FileUploadManager {
  ...
  checkReady() {
    ...
    if (span) {
      span.textContent = ready ? 
        (lang ? lang.t('analyzeData') : 'Analyze Data') : 
        (lang ? lang.t('uploadBothFiles') : 'Upload Both Files');
    }
  }
  ...
  handleSubmit(e) {
    if (!this.files.followers || !this.files.following) {
      e.preventDefault();
      alert(window.languageManager ? window.languageManager.t('uploadBothError') : 'Please upload both files');
      return;
    }
