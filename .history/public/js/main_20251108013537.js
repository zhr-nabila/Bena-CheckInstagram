...
// Simple and Working Language Manager
class LanguageManager {
  constructor() {
    ...
    this.translations = {
      en: {
        ...
        heroSubtitle: "Find out who doesn't follow you back with our premium analytics tool",
        feature1: "Accurate Analysis",
        feature1Desc: "Precise detection of non-reciprocal followers",
        feature2: "Premium Reports", 
        feature2Desc: "Beautiful PDF reports with insights",
        feature3: "Secure & Private",
        feature3Desc: "Your data never leaves your browser",
        startAnalysis: "Start Analysis",
        uploadTitle: "Upload Your Instagram Data",
        uploadSubtitle: "Select followers.json and following.json files",
        chooseFiles: "Choose Files",
        dragDrop: "Drag & drop files or click to browse",
        uploadBoth: "Upload Both Files to Continue",
        analyze: "Analyze Instagram Data",
        analyzing: "Analyzing your Instagram data...",
        resultsTitle: "Analysis Complete",
        resultsSubtitle: "Your Instagram insights:",
        totalFollowers: "Total Followers",
        totalFollowing: "Total Following", 
        notFollowing: "Not Following Back",
        notFollowingList: "Accounts Not Following Back",
        perfectBalance: "Perfect Engagement",
        perfectDesc: "Everyone follows you back!",
        downloadReport: "Download Report",
        newAnalysis: "New Analysis",
        craftedBy: "Created by",
        uploadError: "Please upload both files",
        jsonError: "Please upload JSON files only"
      },
      id: {
        heroTitle: "Temukan Lingkaran Instagram Anda",
        heroSubtitle: "Cari tahu siapa yang tidak follow balik dengan alat analisis premium",
        feature1: "Analisis Akurat",
        feature1Desc: "Deteksi pengikut tidak timbal balik",
        feature2: "Laporan Premium",
        feature2Desc: "Laporan PDF dengan wawasan",
        feature3: "Aman & Pribadi", 
        feature3Desc: "Data tidak keluar dari browser",
        startAnalysis: "Mulai Analisis",
        uploadTitle: "Unggah Data Instagram",
        uploadSubtitle: "Pilih file followers.json dan following.json",
        chooseFiles: "Pilih File",
        dragDrop: "Seret & lepas file atau klik",
        uploadBoth: "Unggah Kedua File untuk Lanjut",
        analyze: "Analisis Data Instagram", 
        analyzing: "Menganalisis data Instagram...",
        resultsTitle: "Analisis Selesai",
        resultsSubtitle: "Wawasan Instagram Anda:",
        totalFollowers: "Total Pengikut",
        totalFollowing: "Total Mengikuti",
        notFollowing: "Tidak Follow Balik",
        notFollowingList: "Akun Tidak Follow Balik",
        perfectBalance: "Engagement Sempurna",
        perfectDesc: "Semua follow balik!",
        downloadReport: "Unduh Laporan",
        newAnalysis: "Analisis Baru",
        craftedBy: "Dibuat oleh",
        uploadError: "Harap unggah kedua file",
        jsonError: "Harap unggah file JSON saja"
      }
    };
    this.init();
  }
  ...
  updateTexts() {
    ...
    const elements = {
      ...
      '.feature:nth-child(1) h3': t.feature1,
      '.feature:nth-child(1) p': t.feature1Desc,
      '.feature:nth-child(2) h3': t.feature2,
      '.feature:nth-child(2) p': t.feature2Desc,
      '.feature:nth-child(3) h3': t.feature3,
      '.feature:nth-child(3) p': t.feature3Desc,
      '.scroll-btn': t.startAnalysis,
    ...
    if (submitBtn) {
      submitBtn.textContent = submitBtn.disabled ? t.uploadBoth : t.analyze;
    }
  ...
  updateResults(t) {
    ...
    const results = {
      ...
      '.stat:nth-child(1) .stat-label': t.totalFollowers,
      '.stat:nth-child(2) .stat-label': t.totalFollowing,
      '.stat:nth-child(3) .stat-label': t.notFollowing,
      '.unfollowers-section h3': t.notFollowingList,
      '.success-state h3': t.perfectBalance,
      '.success-state p': t.perfectDesc,
      '.btn-primary': t.downloadReport,
      '.btn-secondary': t.newAnalysis
    };
...
// Simple and Working File Manager
class FileManager {
  constructor() {
    this.files = {
      followers: null,
  ...
  addFile(file) {
    const type = file.name.toLowerCase().includes('followers') ? 'followers' : 'following';
    this.files[type] = file;
    this.showFile(file, type);
    this.updateForm();
    this.checkReady();
  }
  ...
  showFile(file, type) {
    ...
    div.innerHTML = `
      <div class="file-icon">${type === 'followers' ? '👥' : '📋'}</div>
      <div class="file-info">
        <div class="file-name">${file.name}</div>
    ...
    div.querySelector('.file-remove').onclick = () => this.removeFile(type);
  ...
  checkReady() {
    ...
    if (lang) {
      btn.textContent = ready ? lang.translations[lang.currentLang].analyze : lang.translations[lang.currentLang].uploadBoth;
    } else {
      btn.textContent = ready ? 'Analyze Instagram Data' : 'Upload Both Files to Continue';
    }
  }
  ...
  updateForm() {
    ...
    const existing = form.querySelectorAll('input[type="file"]');
    existing.forEach(input => input.remove());

    // Add new inputs with files
  ...
  handleSubmit(e) {
    if (!this.files.followers || !this.files.following) {
      e.preventDefault();
      const lang = window.languageManager;
      alert(lang ? lang.translations[lang.currentLang].uploadError : 'Please upload both files');
      return;
    }
