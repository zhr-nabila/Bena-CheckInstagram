...
function updateDynamicContent(lang) {
    ...
    if (scrollIndicator && lang === 'id') {
        scrollIndicator.textContent = 'Mulai Analisis';
        scrollIndicator.prepend(document.querySelector('.scroll-arrow'));
    } else if (scrollIndicator) {
        scrollIndicator.textContent = 'Start Analysis';
        scrollIndicator.prepend(document.querySelector('.scroll-arrow'));
    }
}