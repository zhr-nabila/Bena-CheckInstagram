    ...
    pdfForms.forEach(form => {
        form.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                const followersCount = form.querySelector('input[name="followersCount"]').value;
                const followingCount = form.querySelector('input[name="followingCount"]').value;
                const users = form.querySelector('input[name="users"]').value;
                ...
                if (response.ok) {
                    ...
                    a.download = isIndonesian ? 'laporan_instagram_unfollowers.pdf' : 'instagram_unfollowers_report.pdf';
