...
class PremiumFileUploadManager {
    ...
    determineFileType(filename) {
        ...
        // PERBAIKAN: Deteksi file yang lebih akurat
        ...
        // Fallback ke prompt seperti sebelumnya
        const type = prompt(
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    if (blob && blob.size > 0) {
                        ...
                        // Coba metode download otomatis tanpa dialog
                        try {
                            // Method 1: Gunakan createObjectURL dengan anchor click
                            const a = document.createElement("a");
                            a.style.display = "none";
                            a.href = url;
                            
                            // Set filename based on language
                            const isIndonesian = document.querySelector(".lang-btn.active")?.getAttribute("data-lang") === "id";
                            ...
                            // Success message berdasarkan bahasa
                            ...
                            // Fallback: Buka di tab baru jika auto-download gagal
                            const isIndonesian = document.querySelector(".lang-btn.active")?.getAttribute("data-lang") === "id";
                            const fallbackMessage = isIndonesian 
                                ? "PDF siap diunduh. Jika tidak otomatis, cek folder download Anda." 
                                : "PDF is ready to download. If not automatic, check your download folder.";
                ...
                // Error message berdasarkan bahasa
                const isIndonesian = document.querySelector(".lang-btn.active")?.getAttribute("data-lang") === "id";
