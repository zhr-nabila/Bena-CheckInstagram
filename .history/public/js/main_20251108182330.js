...
class PremiumFileUploadManager {
    ...
    setupPDFDownload() {
    // HAPUS SEMUA event listener untuk form PDF
    const pdfForms = document.querySelectorAll('form[action*="download-pdf"]');
    pdfForms.forEach((form) => {
        // Clone form untuk remove event listeners
        const newForm = form.cloneNode(true);
        form.parentNode.replaceChild(newForm, form);
    });
    
    // Biarkan browser handle download secara natural
    console.log('PDF download forms reset to natural behavior');
}
