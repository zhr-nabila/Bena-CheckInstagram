...
class PremiumFileUploadManager {
    ...
    pdfForms.forEach((form) => {
        form.addEventListener("submit", async (e) => {
            ...
            button.innerHTML = `⏳ ${isIndonesian ? 'Membuat PDF...' : 'Creating PDF...'}`;
            button.disabled = true;

            try {
                const formData = new FormData(form);
                
                // Gunakan approach yang berbeda - buka di tab baru
                ...
                tempForm.target = '_blank'; // Buka di tab baru
                ...
                setTimeout(() => {
                    this.showSuccess(
                        isIndonesian 
                            ? "PDF sedang dibuat di tab baru..." 
                            : "PDF is being generated in new tab..."
                    );
                }, 1000);
