...
class SparkleCursorManager {
    ...
    createCursor() {
        ...
        this.sparkle.className = 'sparkle';
        
        this.cursor.appendChild(this.sparkle);
    ...
    addTrail(x, y) {
        ...
        if (trail) {
            ...
            trail.element.style.transform = 'scale(1) rotate(0deg)';
        }
    }
        ...
        this.trails.forEach(trail => {
            if (trail.active) {
                ...
                if (trail.age >= 1) {
                    ...
                    const rotation = trail.age * 180;
                    trail.element.style.opacity = (1 - trail.age).toString();
                    trail.element.style.transform = `scale(${scale}) rotate(${rotation}deg)`;
                }
            }
        });
