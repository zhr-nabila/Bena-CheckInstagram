...
<body>
    ...
    <!-- Language Toggle -->
    <button class="language-toggle" aria-label="Toggle language">ID</button>
    ...
    <section class="hero">
        <div class="hero-content">
            ...
            <p>Uncover who's not following you back with our sophisticated analytics platform. Private, secure, and
                designed for those who appreciate premium experiences.</p>
            ...
            <div class="upload-card">
                <div class="upload-area" id="uploadArea">
                    ...
                    <div class="upload-text">
                        ...
                        <p>Select your followers.json and following.json files exported from Instagram to begin premium
                            analysis</p>
                    </div>
