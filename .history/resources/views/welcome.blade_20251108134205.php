            ...
            <div class="results-card visible">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-label">@lang('messages.stats.followers')</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number">{{ $followingCount }}</div>
                        <div class="stat-label">@lang('messages.stats.following')</div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-number">{{ count($notFollowBack) }}</div>
                        <div class="stat-label">@lang('messages.stats.not_following_back')</div>
                    </div>
                </div>
